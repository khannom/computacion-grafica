const translationX = new THREE.Matrix4();
translationX.set(
    1, 0, 0, 0.02,
    0, 1, 0, 0,
    0, 0, 1, 0,
...
const escalation = new THREE.Matrix4();
escalation.set(
    1.002, 0, 0, 0,
    0, 1.002, 0, 0,
    0, 0, 1.002, 0,
...
let transformation = rotationY.multiply(rotationX)
transformation = transformation.multiply(escalation)
